              ...
              Expanded(
                child: GridView.count(
                  ...
                  children: [
                    ...
                    _item(
                      image: const AssetImage('assets/items/9.png').assetName,
                      title: 'Spicy Burger',
                      price: '\$7.39',
                      item: '12 item',
                    ),
                    _item(
                      image: const AssetImage('assets/items/10.png').assetName,
                      title: 'Special Black Burger',
                      price: '\$7.39',
                      item: '39 item',
                    ),
                    _item(
                      image: const AssetImage('assets/items/11.png').assetName,
                      title: 'Special Cheese Burger',
                      price: '\$8.00',
                      item: '2 item',
                    ),
                    _item(
                      image: const AssetImage('assets/items/12.png').assetName,
                      title: 'Jumbo Cheese Burger',
                      price: '\$15.99',
                      item: '2 item',
                    ),
