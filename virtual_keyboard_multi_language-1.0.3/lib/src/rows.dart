...
const List<List> _keyRowsNumeric = [
  ...
  const [
    ...
    '2',
    '3',
    VirtualKeyboardKeyAction.Escape
  ],
  // Row 1
  const [
    '4',
  ...
  const [
    ...
    '8',
    '9',
    VirtualKeyboardKeyAction.Clear
  ],
  // Row 1
  const [
    '.',
...
List<VirtualKeyboardKey> _getKeyboardRowKeysNumeric(rowNum) {
  ...
  return List.generate(_keyRowsNumeric[rowNum].length, (int keyNum) {
    ...
    if (_keyRowsNumeric[rowNum][keyNum] is String) {
      ...
      var action =
          _keyRowsNumeric[rowNum][keyNum] as VirtualKeyboardKeyAction;
      return VirtualKeyboardKey(
